...
>"%TMP_PS%" echo # Generated by install.bat - updates user PATH for Matrix, Pomodoro and osfetch
...
>>"%TMP_PS%" echo $osfetchDir  = Join-Path $repoPath 'Osfetch'
>>"%TMP_PS%" echo $required    = @($matrixDir, $pomodoroDir, $osfetchDir)
>>"%TMP_PS%" echo.
